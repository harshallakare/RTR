...
// *** IMPLEMENTED DUE TO DIFFERENT BEHAVIOUR OF gets_s() I fgets() I fscanf() ON  DIFFERENT PLATFORMS***
// * **BACKSPACE I CHARACTER DELETION AND ARROW KEY CURSOR MOVEMENT NOT  IMPLEMENTED * **
