...
int main(void)
{
	...
	printf("iArray[0] (2st Element) = %d\n", iArray[1]);
	printf("iArray[0] (3st Element) = %d\n", iArray[2]);
	...
	printf("Number of Element In 'Flaot' Array 'fArray[]' = %d Elements \n",fArray_num_elements);
	printf("Size of Array 'fArray[]' (%d Element * %d Bytes)	= %d bytes \n\n",fArray_num_elements, float_size, fArray_size);

	// ****** cArray[]******
	printf("\n\n");
	printf("In-Line Initialization ANd Piece-meal Display of Element Of Array 'cArray[]' : \n\n ");
